...
function Anchors:__init(proposal_net, scales)
  ...
  for i,s in ipairs(scales) do
    ...
    print(string.format("the scales : %d(%d-%d), real region: height=%d, width=%d",i,s,2*a,self.localizers[i]:featureToInputRect(0, 0, 0, 1):height(),self.localizers[i]:featureToInputRect(0, 0, 1, 0):width()))
